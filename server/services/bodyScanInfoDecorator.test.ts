import {
  createMockBodyScanClient,
  createMockHmppsAuthClient,
  createMockXrayBodyScansApiClient,
} from '../data/__testutils/mocks'
  ...
  describe('decorate', () => {
    ...
    describe('when feature is enabled (XRBS client)', () => {
      ...
      test('happy path', async () => {
        ...
        expect(xrayBodyScansApiClient.getBulkScanSummary).toHaveBeenCalledWith([
          'A1234AA',
          'A1234AB',
          'A1234AC',
          'A1234AD',
