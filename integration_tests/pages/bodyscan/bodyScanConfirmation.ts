  ...
  addCaseNote = (prisonNumber: string) => ({
    exists: () =>
      Page.checkLink(
        ...
        `https://prisoner-dev.digital.prison.service.justice.gov.uk/save-backlink?service=welcome-people-into-prison&returnPath=/recent-arrivals&redirectPath=/prisoner/${prisonNumber}/add-case-note`,
      ),
  })
}
